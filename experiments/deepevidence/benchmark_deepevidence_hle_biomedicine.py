...
def gpt_5():
    ...
    # correct ones, 9 out of 40 = 22.5% accuracy
...
def sonnet_45():
    ...
    RESULTS_DIR = os.path.join(REPO_BASE_DIR, "experiments/deepevidence/results/deepevidence/hle_biomedicine_40_sonnet_45")
    os.makedirs(RESULTS_DIR, exist_ok=True)
