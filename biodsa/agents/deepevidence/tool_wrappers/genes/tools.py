...
class UnifiedGeneSearchToolInput(BaseModel):
    ...
    organism_code: Optional[str] = Field(
        default="hsa",
        description="KEGG organism code for gene search (default: 'hsa' for human, 'mmu' for mouse, etc.)"
    )
...
results, output = search_genes_unified(
    ...
    organism_code={repr(organism_code)},
